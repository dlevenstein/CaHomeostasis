figfolder  = '/Users/dl2820/Project Repos/CaHomeostasis/DailyNotebook/Notebook20210820';
...
parms_noCDV = parms;
parms_noCDV.kvd_bar = 0;
[simresults_noCDV,simparms_noCDV] = Run_SynHomeo2_CdV(manip,parms_noCDV,timeparms,...
    'showfig',true,'showfig_ActFun',true);
...
%%
Plot_SynHomeo(simresults_noCDV,'FixYRange',false,'linecolor','b','fignum',2,'figwidth',2)
Plot_SynHomeo(simresults,'FixYRange',false,'saveFig',figfolder,...
    'figname','TTX_NoCDV','fignum',2,'figwidth',2)
%%
close all
...
Plot_SynHomeo(simresults_noCDV,'FixYRange',false,'linecolor','b','fignum',2,'figwidth',2)
Plot_SynHomeo(simresults,'FixYRange',false,'saveFig',figfolder,...
    'figname','TTX_NoCDV_PreOsc','fignum',2,'figwidth',2)