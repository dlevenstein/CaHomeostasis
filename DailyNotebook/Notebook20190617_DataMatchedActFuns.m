...
Ca_0 = -6.854;       %GluA1-independent (i.e. baseline) Calcium concentration
                    %(from SS)
Ca_PSP = 0.2;     %Calcium from 1Hz PSPs with GluA1 fully phosphorylated
Ca_Kalpha = -6;   %Ca midpoint for CamKII alpha
%Ca_Kbeta = 0.5;  %Ca midpoint for CamKII beta
Ca_Kdelta = 1;  %How much CamKIIbeta lowers the "threshold" of CamK
                %10x more sensitive
Ca_CaN = -6.2;     %Ca midpoint for CaN
Ca_beta = -6.7;    %Ca midpoint for CamKII alpha-beta transition

s_CamK = 8;    %Steepness of CamKII activation
s_CaN = 4;      %Steepness of CaN activation
