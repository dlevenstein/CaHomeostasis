...
figfolder  = '/Users/dl2820/Project Repos/CaHomeostasis/DailyNotebook/Notebook20201217';
...
[simresults,simparms] = Run_SynHomeo(manip,parms,timeparms,'saveFig',figfolder,'figname','TTXStep_WT')
...
%%
s = zeros(size(t_sec));
for tt = 2:length(t_sec)   
    dsdt = kd.*(1-s(tt-1)) - kf.*s(tt-1);
    s(tt) = s(tt-1) + dsdt.*dt;
end
%%
figure
